...
## Một vài project mình đã làm với JavaScript (TypeScript)

- [Portfolio Sử dụng ThreeJS, NextJS và TypeScript](https://github.com/cobeo2004/portfolio-nextjs)
- [Book API sử dụng ExpressJS, NodeJS, MongoDB và JavaScript](https://github.com/cobeo2004/Book-BackEnd)
- [Twitter Fake sử dụng T3 Stack](https://github.com/cobeo2004/t3-social-media)
